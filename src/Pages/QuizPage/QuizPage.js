            ...
            <div className="quiz-question">
              ...
              <div className="quiz-options">
                {quiz[index]?.option.length > 0 ? (
                  ...
                  <RadioGroup aria-label="gender"  onClick={(e)=>handleResponse(e)}>
                    {quiz[index]?.option.map((option) => (
                      <FormControlLabel value={option.option} name={option.key.toString()} control={<Radio />} label={option.option} />
                    ))}
                  </RadioGroup>
                  </FormControl>
                ) : (
